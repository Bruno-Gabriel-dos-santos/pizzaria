...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="{{route('loguin.index')}}" class="nav-link">Login</a></li>
    ...
    <!-- END nav -->
    <br><br><h1 class="text-center fs-1">Login PizzaPizza</h1><p class="breadcrumbs text-center" style="font-size: 50px;cursor: pointer;">⌄</p>

                        <div class="card-body w-75 mx-auto">
                        <form action="{{route('loguin.loguin')}}" method="POST">
                            @csrf
                            <div class="form-group">
                            @error('erro')
                                <div class="alert alert-danger">Nick ou senha incorretos tente novamente.</div>
                            @enderror
                            <label for="nick">Nick:</label>
                            <input type="text" class="form-control" name="nick" id="nick" placeholder="Digite o nick">
                            </div>
                            <!-- Exibição de mensagens de erro -->
                            @error('nick')
                                <div class="alert alert-danger">O campo Nick não foi preenchido</div>
                            @enderror
                            <div class="form-group">
                            ...
                            <!-- Exibição de mensagens de erro -->
                            @error('senha')
                                <div class="alert alert-danger">O campo Senha não foi preenchido</div>
                            @enderror
