...
@if($pag[0] == "produtos")
    <!-- END nav --><br><br><h2 class="text-center">Exclusão de Produtos</h2><br><br>

     <!-- CAIXA DE MENSAGEM -->
     <div class="container w-75 mx-auto p-4">

          <h3>Campos de pesquisa para exclusão</h3>
    ...
    <tbody>
        ...
        @endforeach
            <td>
            <form method="POST" action="{{ route('admexcluir') }}">
                @csrf
                @method('DELETE')
...
@if($pag[0] == "fornecedor")
    <!-- END nav --><br><br><h2 class="text-center">Exclusão de Fornecedor</h2><br><br>
...
@if($pag[0] == "estoque")
    <!-- END nav --><br><br><h2 class="text-center">Exclusão de Item/insumo </h2><br><br>
...
@if($pag[0] == "funcionario")
    <!-- END nav --><br><br><h2 class="text-center">Exclusão de Funcionario </h2><br><br>
