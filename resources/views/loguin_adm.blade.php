...
@section('content')
    ...
    <!-- END nav -->
    <br><br><h1 class="text-center fs-1">Login Adiministrador</h1><p class="breadcrumbs text-center" style="font-size: 50px;cursor: pointer;">⌄</p>

                        <div class="card-body w-75 mx-auto">
                        <form action="{{route('loguin_adm.login')}}" method="POST">
                            @csrf
