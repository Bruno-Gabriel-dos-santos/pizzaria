	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active"><a href="{{route('cadastro.index')}}" class="nav-link">Cadastrar</a></li>
	        </ul>
	      </div>
		</div>
	</nav>
    <!-- END nav -->
    <br><br><h1 class="text-center fs-1">Cadastre-se na PizzaPizza</h1><p class="breadcrumbs text-center" style="font-size: 50px;cursor: pointer;">⌄</p><br><br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="numero_telefone" id="numero_telefone" placeholder="Digite o número de telefone">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="numero_end" id="numero_end" placeholder="Digite o número do endereço">
                        </div>
                        @error('numero_end')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
