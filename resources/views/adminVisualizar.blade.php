...
@if($pag[0] == "produtos")
    <!-- END nav --><br><br><h2 class="text-center">Visualização de Produtos</h2><br><br>

     <!-- CAIXA DE MENSAGEM -->
     <div class="container w-75 mx-auto p-4">

          <h3>Campos de pesquisa para visualização</h3>
...
@if($pag[0] == "fornecedor")
    <!-- END nav --><br><br><h2 class="text-center">Visualização de Fornecedor</h2><br><br>
...
@if($pag[0] == "estoque")
    <!-- END nav --><br><br><h2 class="text-center">Visualização de Item/insumo </h2><br><br>
...
@if($pag[0] == "funcionario")
    <!-- END nav --><br><br><h2 class="text-center">Visualização de Funcionario </h2><br><br>
